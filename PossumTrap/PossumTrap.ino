...
This is the standard TX. Earth GPIO0 and the ESP8266 will start a connection to the WIFI and send
a GET request to the host, pasing the 'name' as a parameter. The name contains the id of the current
board and the host logs the name and the time.
...
void sendEvent() {
  ...
  client.print(String("GET ") + "http://"+host+"/updatelog.php?" + "name=" + myid + " HTTP/1.1\r\n" +
               "Host: " + host + "\r\n" + 
               "Connection: close\r\n\r\n");
  delay(500);
}
