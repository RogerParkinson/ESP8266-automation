...
void sendEvent() {
  ...
  // This will send the request to the server (anything with type > 1 will sound the chime 'param' times)
  client.print(String("GET ") + "http://"+host+"/processevent.php?" + "name=" + myid  + "&type=" + 2 + "&param=" + 1 + " HTTP/1.1\r\n" +
               "Host: " + host + "\r\n" + 
               "Connection: close\r\n\r\n");
  delay(500);
}
